...
class opFinishPage extends StatefulWidget {
  const opFinishPage({Key? key}) : super(key: key);

  @override
  State<opFinishPage> createState() => _FinishPageState();
}

class _FinishPageState extends State<opFinishPage> {
  @override
  void initState() {
    super.initState();
  }
